...
\begin{equation}
  \text{cor}\left(\textit{y}_{\textit{t}}, \textit{x}_{\textit{t-h}}\right)
\end{equation}
...
\begin{gather}
  \textit{y}_{\textit{t}} = \textit{a} + \textit{b} \textit{x}_{\textit{t-1}} + \textit{e}_{\textit{t}} \\
  \textit{e}_{\textit{t}} \sim \text{N}(0, \sigma^2) 
\end{gather}
